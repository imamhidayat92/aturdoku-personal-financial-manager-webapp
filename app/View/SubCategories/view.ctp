<div class="row">
    ...
    <div class="large-12 columns">
        <ul class="breadcrumbs">
            ...
            <li><a href="#"><?php echo $subCategory['Category']['name']; ?></a></li>
        </ul>
    </div>
    
    <div class="large-3 columns">
        <h1 class="aturdoku-nav-head aturdoku-bg-black">SUBKATEGORI</h1>
    </div>
    <div class="large-9 columns">
        <h2 class="special-font underline">Data Transaksi</h2>
        <h4>Kategori: <?php echo $subCategory['Category']['name'] ?></h4>
        <!-- Tabel Index -->
